import { Attribute, ComponentAttribute } from '@strapi/strapi/lib/types/core/attributes';
import { KeysBy, SchemaUID, StringRecord } from '@strapi/strapi/lib/types/utils';
